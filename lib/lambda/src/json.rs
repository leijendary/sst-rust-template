use lambda_http::{http::header::CONTENT_TYPE, Body, Error as LambdaError, Response};
...
pub fn error_response(result: ErrorResult) -> Result<Response<Body>, LambdaError> {
...
fn build_response(status: u16, json: String) -> Result<Response<Body>, LambdaError> {
    Response::builder()
